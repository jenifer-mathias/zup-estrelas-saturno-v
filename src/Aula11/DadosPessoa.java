...
public class DadosPessoa {   // classe com atributos
	...
	public void calculoIdade() { // método para calcular a idade da pessoa
		...
		if ((diaNascimento <= 0) && (diaNascimento > 31)) {    // poderia implementar um loop para repetir até que o usuário digitasse algo válido
